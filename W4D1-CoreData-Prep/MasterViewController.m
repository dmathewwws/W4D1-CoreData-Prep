...
- (void)insertNewObject:(id)sender {
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Add a Book" message:@"" preferredStyle:UIAlertControllerStyleAlert];
    ...
    [alert addAction:[UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        Book *newBook = [[Book alloc] initWithContext:context];
        
        // If appropriate, configure the new managed object.
        newBook.name = _myTextField.text;
...
- (NSFetchedResultsController<Book *> *)fetchedResultsController {
    ...
    NSFetchedResultsController<Book *> *aFetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.managedObjectContext sectionNameKeyPath:nil cacheName:@"Master"];
...
- (void)controller:(NSFetchedResultsController *)controller didChangeObject:(id)anObject
    ...
    switch(type) {
        ...
        case NSFetchedResultsChangeUpdate:
            [self configureCell:[tableView cellForRowAtIndexPath:indexPath] withBook:anObject];
            break;
